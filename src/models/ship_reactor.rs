...
impl ShipReactor {
    ...
    pub fn new(symbol: Symbol, name: String, description: String, condition: f64, integrity: f64, power_output: i32, requirements: models::ShipRequirements, quality: f64) -> ShipReactor {
        ShipReactor {
            symbol,
            name,
            description,
